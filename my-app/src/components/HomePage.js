...
class HomePage extends Component {
    ...
    render() {
      return (
        <MDBContainer>
          <MDBBtn color="primary" onClick={this.toggle(2)}>Donate</MDBBtn>
          ...
          <MDBBtn color="primary" onClick={this.toggle(3)}>Seek Help</MDBBtn>
          <MDBModal isOpen={this.state.modal3} toggle={this.toggle(3)} size="sm">
            ...
            <MDBModalBody color="primary">
              <p color="black">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore
              magna aliqua.</p>
            </MDBModalBody>
            <MDBModalFooter>
